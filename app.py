...
class ChartBuilder:
    ...
    def draw_fan_animated(v_points, u0_measured, u_nominal, measured_y, y_max=10.0, y_dtick=1.0, x_dtick=1.0, show_fan=True, show_sweep=True):
        ...
        # CÁLCULO DE TICKS: Se recalculan en cada renderizado basado en x_dtick
    ...
    def draw_area_shifting_demo(v_points, u_nominal, m_y_start, u0_end, ref_delta_pivot, y_max=10.0, y_dtick=1.0, x_dtick=1.0, show_limit_line=False, show_sweep=True):
        ...
        fig.add_trace(go.Scatter(x=v_points, y=m_y_start, mode='lines', fill='tozeroy', line=dict(width=0), fillcolor='rgba(0,0,0,0)', hoverinfo='skip', visible=show_sweep, xaxis='x2', yaxis='y2', cliponaxis=False), row=1, col=2) 
        ...
        base_annotations.append(dict(
            x=0.5, y=0.23, xref="x3 domain", yref="y3 domain", 
        ...
        def get_dynamic_annots(i_r_val, i_c_val, curr_u0_disp, angle_rad=None):
            ...
            annots = [
                dict(x=pos_x_lateral, y=0.93, text=f"<b>A  = 0,5Uo = {curr_u0_disp_str} x10⁻³</b>", showarrow=False, font=dict(size=12, color="black", family="Arial Black"), bgcolor=Config.COLOR_BOX_05, borderpad=6, xref="paper", yref="paper", xanchor="right", yanchor="middle"),
...
def main():
    ...
    with st.sidebar.expander("Configuración limite máximo para no action", expanded=False):
        ...
        # MODIFICACIÓN: El valor inicial y máximo del 1,0Uo final es ahora 4,0
    ...
    if u_linea > 0:
        ...
        with tab_fan:
            ...
            with col2:
                ...
                # MODIFICACIÓN: staticPlot=False para permitir actualizaciones de escala
                st.plotly_chart(fig_fan, use_container_width=True, config={'displayModeBar': False, 'staticPlot': False}, key="tend_fan")
        ...
        with tab_area:
            ...
            # MODIFICACIÓN: staticPlot=False para permitir actualizaciones de escala y animación
